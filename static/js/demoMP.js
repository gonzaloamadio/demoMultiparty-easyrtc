...
function handleWindowResize() {
    ...
    //fullpage.style.width = window.innerWidth-240 + "px";
    fullpage.style.height = 608 + "px";
    fullpage.style.width = $("#container").width() + "px";
    ...
    applyReshape(fullpage, $("#container").width(), 608);
}
